...
You can install a development version of the Vizumap package from [GitHub](https://github.com/lydialucchesi/Vizumap)
...
In this novel approach, each map region is pixelated, and then each pixel is filled with a colour from the gradient that falls within the estimate's margin of error. Regions that appear visually as a solid colour reflect smaller margins of error, while more pixelated regions indicate greater uncertainty. These maps can be animated using visuanimation techniques to provide a novel uncertainty visualisation experience.
...
Vizumap: An R package for visualizing uncertainty in spatial data, DOI: 10.5281/zenodo.1013930, https://zenodo.org/record/1479951#.Xnr_Qy1L2L8.
