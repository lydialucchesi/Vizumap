...
View the package vignette with the command below or online [here](https://lydialucchesi.github.io/Vizumap/articles/Vizumap.html). 
...
In the exceedance probability map [[2](#references)], each geographic area is filled with a color representing the probability of exceeding some threshold of concern or target. Information on calculating exceedance probabilities can be found in `?build_emap`, `vignette("Vizumap")`, and [here](https://lydialucchesi.github.io/Vizumap/articles/Vizumap.html).
